"""
Base network class with weight initialization utilities.
"""
...
class BaseNetwork(nn.Module):
    """
    Base class for networks with weight initialization support.

    Args:
        init_type: Initialization type ('normal', 'xavier', 'kaiming', 'orthogonal', 'none')
    ...
    def init_weights(self):
        ...
        Supported init_type: normal | xavier | xavier_uniform | kaiming | orthogonal | none
