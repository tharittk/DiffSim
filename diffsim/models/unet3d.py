"""
3D UNet for unconditional diffusion models.

Based on the annotated diffusion implementation, extended to 3D:
...
class Unet3D(nn.Module):
    """
    3D UNet for unconditional diffusion.

    Args:
        dim: Base channel dimension
        init_dim: Initial convolution output channels (defaults to dim)
        out_dim: Output channels (defaults to input channels)
